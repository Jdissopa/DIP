...
writtenDir = './retinal_quality/for_slide_stare_2020_04_16/';
imageFolder = './dataset/stare-photos/';

fID = fopen('./retinal_quality/for_slide_stare_2020_04_16/stare_stats.csv', 'at');
...
for I = 1:402
    ...
    filepath = strcat(imageFolder,filename,'.ppm');
