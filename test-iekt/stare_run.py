...
if __name__ == '__main__':
    ...
    f = open('D:\workspace\DIP\oRGB\experiment\iekt\STARE\sharpening\stats.csv', 'ab')

    image_path = r'D:\workspace\DIP\oRGB\dataset\stare-photos'
    brightened_dest = r'D:\workspace\DIP\oRGB\experiment\iekt\STARE\brigtening'
    sharpening_dest = r'D:\workspace\DIP\oRGB\experiment\iekt\STARE\sharpening'

    # list all ppm files in image_path directory
    ims = glob.glob(image_path+r'\*.ppm')
