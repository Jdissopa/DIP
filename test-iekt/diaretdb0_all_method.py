...
if __name__ == '__main__':
    ...
    fs = [open(r"C:\Users\jessa\OneDrive - Prince of Songkla University\papers\รายงานความก้าวหน้า4\\" + str(i) + "_stats.csv", 'ab') for i in range(1, 5)]

    image_path = r'D:\workspace\DIP\oRGB\dataset\diaretdb0_v_1_1\resources\images\diaretdb0_fundus_images'

    enhancement_methods = ['sA+sC+sX+sZ','sA+sB+sC+sW+sX','A+B+C+X','sC+sX']

    brightening_dests = [r"D:\workspace\DIP\oRGB\experiment\iekt\DiaretDB0\\" + method + "\\brightening" for method in enhancement_methods]
    sharpening_dests = [r"D:\workspace\DIP\oRGB\experiment\iekt\DiaretDB0\\" + method + "\\sharpening" for method in enhancement_methods]
